...
def listen_for_wake_word():
    ...
    try:
        ...
        print(
            "Genie Not Available. Your Laptop is not connected to the Internet."
        )
        speak(
            "Genie Not Available. Your Laptop is not connetced to the Internet."
        )
    return False
...
def search_wikipedia(query):
    try:
        ...
        print(
            "The search query is ambiguous. Please try again with a more specific query."
        )
        speak(
            "The search query is ambiguous. Please try again with a more specific query."
        )
...
def get_weather():
    ...
    with sr.Microphone(device_index=0) as source:
        ...
        try:
            ...
            print(
                f"The weather in {city} is {description} with a temperature of {temperature} degrees Fahrenheit and a humidity of {humidity}%."
            )
            speak(
                f"The weather in {city} is {description} with a temperature of {temperature} degrees Fahrenheit and a humidity of {humidity} percent."
            )
        except sr.UnknownValueError:
...
if __name__ == "__main__" or 1:
    ...
    print(
        "I am a virtual assistant designed to assist you with tasks on your desktop computer. You can activate me by using a wake word."
    )
    speak(
        "I am a virtual assistant designed to assist you with tasks on your desktop computer. You can activate me by using a wake word."
    )
        ...
        if listen_for_wake_word():
            ...
            if query is not None:
                ...
                if "take a break" in query or "don't listen" in query or "stop listening" in query:
                    print(
                        "For how many seconds do you want me to take a break?"
                    )
                    speak(
                        "For how many seconds do you want me to take a break?"
                    )
                    ...
                    pdfpathpdf = os.path.join(
                        r"C:\Path\To\Your\Downloads",
                        pdfname
                    )
                    try:
                        ...
                        print(
                            "File not found! Please download and then try to read."
                        )
                        speak(
                            "File not found! Please download and then try to read."
                        )
                ...
                # Check if user wants to speak the to-do list
                    ...
                    try:
                        reminder_year = int(
                            r.recognize_google(audio_year, language='en-in')
                        )
                    ...
                    cryptoname = query.split("get crypto currency info on")[
                        1].strip()
